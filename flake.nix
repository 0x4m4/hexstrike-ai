  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        hexstrike-ai-pkg = python.pkgs.buildPythonApplication (hexstrike-attrs // {
          name = "hexstrike-ai";
          ...
          installPhase = ''
            ...
            chmod +x $out/bin/hexstrike_server.py $out/bin/hexstrike_mcp.py

            wrapProgram $out/bin/hexstrike_server.py \
              --prefix PATH : ${pkgs.lib.makeBinPath corepkgs}
            wrapProgram $out/bin/hexstrike_mcp.py \
              --prefix PATH : ${pkgs.lib.makeBinPath corepkgs}
      ...
      in
      {
        devShell = pkgs.mkShell {
          ...
          buildInputs = [ hexstrike-ai-pkg ];
        };

        packages = rec {
          hexstrike-ai = hexstrike-ai-pkg;
          default = hexstrike-ai;
        };
